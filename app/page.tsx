...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://mandate4.org/democratic-containment'
const SHARE_TEXT = 'Democratic Containment: The system has a name. Now we have the blueprint to break it. Read this new analytical framework on Nigeria\'s managed democracy.'
...
<section className="share-section">
  <div className="share-container">
    ...
    <div className="share-card">
      <h3 className="share-card-title share-card-title--gold">
      ...
      <div className="share-copy-section">
        <p className="share-copy-label">Or copy the link:</p>
        ...
        <div id="copyStatus" className="share-copy-status">✓ Link copied to clipboard!</div>
      </div>
    </div>
  </div>
</section>
